(function () {
  ...
  const I18N = {
    ...
    hold_sec: { ko: "초…", en: "s…" },
    hold_cancel: { ko: "놓으면 다시 시작", en: "Let go and it starts over" },
    ...
    backup_desc: { ko: "클라우드와 별개로, 파일로 백업하고 불러올 수 있어요. (불러오면 현재 내용을 덮어씁니다 — 확인 후 진행)", en: "Export your notebook as a file, or import one (import overwrites current data — you'll be asked to confirm)." },
    ...
    ts_later_do: { ko: "보관하기", en: "Move to Later" },
    ...
    send_to: { ko: "오른쪽 원씽으로 보내기", en: "Set as your One Thing" },
    ...
    hint_count: { ko: "오늘 {0}개의 원씽을 끝냈어요. 다음 하나를 골라보세요.", en: "{0} One Things done today — pick the next one." },
    ...
    s_unconf_msg: { ko: "아직 클라우드 설정이 비어 있어요.", en: "Cloud sync isn't configured yet." },
    ...
    pfc_head: { ko: "🛠 플랫폼 전체 현황", en: "🛠 Platform overview" },
    ...
    wd_done: { ko: "탈퇴가 완료됐어요. 그동안 함께해서 감사했습니다.", en: "Your account has been deleted. Thank you for being with us." },
    ...
    um_switch: { ko: "로그아웃", en: "Log out" },
    um_lang: { ko: "한/EN", en: "한/EN" },
    ...
    sr_sent: { ko: "보냈어요 — 상대의 집중에 맞춰 전달됩니다", en: "Sent — it'll arrive with their focus in mind" },
    ...
    rq_status_done_now: { ko: "즉시완료됨", en: "Completed instantly" },
    rq_status_onething: { ko: "⭐ 원씽으로 처리 중", en: "⭐ Doing as One Thing" },
    rq_to_todo: { ko: "내 할 일로 추가", en: "Add to my to-dos" },
    rq_added: { ko: "내 할 일에 추가됨", en: "Added to your to-dos" },
    rq_done: { ko: "즉시완료", en: "Complete now" },
    rp_head: { ko: "답장", en: "Reply" },
    rp_to: { ko: "받는 사람: {0}", en: "To: {0}" },
    rp_ph: { ko: "답장 내용을 적어보세요…", en: "Write your reply…" },
    rq_delete: { ko: "삭제", en: "Delete" },
    rq_added_todo: { ko: "할 일에 추가했어요", en: "Added to your to-dos" },
    ...
    rq_sel: { ko: "선택 삭제", en: "Select" },
    rq_sel_del: { ko: "삭제 ({0})", en: "Delete ({0})" },
    rq_cancel: { ko: "취소", en: "Cancel" },
    rq_delall: { ko: "전체 삭제", en: "Delete all" },
    rq_del_confirm: { ko: "요청 {0}건을 삭제할까요? 내 요청함에서만 사라지고 상대방에게는 남아 있어요.", en: "Delete {0} request(s)? They'll only be removed on your side." },
    rq_deleted: { ko: "{0}건을 삭제했어요", en: "Deleted {0} request(s)" },
    ...
    sync_acct_help: { ko: "로그인한 계정 기준으로 자동 동기화됩니다. 같은 계정으로 다른 기기에서 로그인하면 같은 할 일이 보여요.", en: "Auto-syncs by your account. Log in with the same account on another device to see the same to-dos." },
    ...
    break_started: { ko: "휴식 시작 — 5분 뒤에 알려드릴게요", en: "Break started — you'll get a nudge in 5 minutes" },
